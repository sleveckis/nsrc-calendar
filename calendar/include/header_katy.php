...
<div id="page-wrapper" class="container"> <!-- added class container to make content fit within 1140px container -  same as drupal - KN -->
...
<div id="menu-bar" style="text-align: left;" class="nav clearfix"><section id="block-block-7" class="block block-block menu-wrapper menu-bar-wrapper clearfix odd first block-count-1 block-region-menu-bar block-7" >
  ...
  <ul class="menu clearfix"><li class="first leaf menu-depth-1 menu-item-236"><a href="/" title="" class="active"><span>HOME</span></a></li><li class="leaf menu-depth-1 menu-item-385"><a href="/about" title=""><span>ABOUT</span></a></li><li class="leaf menu-depth-1 menu-item-386"><a href="/activities" title=""><span>ACTIVITIES</span></a></li><li class="leaf menu-depth-1 menu-item-387"><a href="/news" title=""><span>NEWS</span></a></li><li class="leaf menu-depth-1 menu-item-389"><a href="/supporters" title=""><span>SUPPORTERS</span></a></li><li class="last leaf menu-depth-1 menu-item-390"><a href="/calendar" title=""><span>calendar</span></a></li></ul>
</nav>
...
</section> <!-- close id=block-google-cse-google-cse -->
