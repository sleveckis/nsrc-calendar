...
<html>
  <head>
    <title>Help: Last Name - User Registration (Network Startup Resource Center Network Education Calendar)</title>
</head>
<body bgcolor="#ffffff">
...
Your first and last name will appear to other users as the record owner for network training events 
that you create. Please enter your last name as you would want others to see it. If you have more than 
one last name please enter in as many as you like or use.<p>
