...
<html>
  <head>
    <title>Help: Name - User Registration (Network Startup Resource Center Network Education Calendar)</title>
</head>
<body bgcolor="#ffffff">
...
This is the name that will appear to other users if your register a workshop. Please enter your name 
in as you would want others to see it.
<p>
Since your name will appear as entered we suggest first names first, then last names, not separated 
by commas or in reverse order.
